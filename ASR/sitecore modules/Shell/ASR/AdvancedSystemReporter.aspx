<%@ Page language="c#" Codepage="65001" AutoEventWireup="true" Inherits="ASR.sitecore_modules.Shell.ASR.AdvancedSystemReporter" CodeBehind="AdvancedSystemReporter.aspx.cs" %>
      ...
      <tr>
        <td id="GridCell" height="100%" valign="top" style="background:#e9e9e9">
          ...
          <ca:Grid id="DataGrid" 
            ...
            CssClass="Grid" 
            EmptyGridText = "No data available"
            ShowHeader="true"
